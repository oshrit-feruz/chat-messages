defmodule DemoGameWeb.WordLiveTest do
  use DemoGameWeb.ConnCase

  import Phoenix.LiveViewTest
  import DemoGame.WordsFixtures

  @create_attrs %{guess_word: "some guess_word"}
  ...
  describe "Index" do
    ...
    test "updates word in listing", %{conn: conn, word: word} do
      ...
      assert html =~ "some updated guess_word"
    end
